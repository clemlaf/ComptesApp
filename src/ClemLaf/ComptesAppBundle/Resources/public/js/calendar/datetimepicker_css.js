...
var CalPosOffsetX = 40; //X position offset relative to calendar icon, can be negative value
...
var MonthYearColor = "#B9C8FF";//cc0033"; //Font Color of Month and Year in Calendar header.
var WeekHeadColor = "#B9C8FF"; //var WeekHeadColor="#18861B";//Background Color in Week header.
var SundayColor = "#B9C8FF"; //var SundayColor="#C0F64F";//Background color of Sunday.
var SaturdayColor = "#B9C8FF"; //Background color of Saturday.
var WeekDayColor = "#FFE3B9"; //"#FFEDA6"; //Background color of weekdays.
var FontColor = "blue"; //color of font in Calendar day cell.
var TodayColor = "#FFbd35";//"#ffbd35"; //var TodayColor="#FFFF33";//Background color of today.
...
var MthSelColor = "#B9C8FF";//cc0033"; //color of font of Month selector if "MonthSelector" is "arrow".
...
var imageFilesPath = "../../../../bundles/testtestapp/js/calendar/images2/";
//Configurable parameters end

//use the Month and Weekday in your preferred language.
var MonthName = ["Janvier", "Février", "Mars", "Avril", "Mai", "Juin", "Juillet", "Aout", "Septembre", "Octobre", "Novembre", "Decembre"];
